...
Partial Class Form_Resident
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_Resident))
        Panel1 = New Panel()
        ...
        Label1.Location = New Point(897, 189)
        Label1.Name = "Label1"
